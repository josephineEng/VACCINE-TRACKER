...
<div class="w3-container">
        ...
        <div style="display: flex;align-items: center; justify-content: center;">
            <h5 style="align-items: center;"> <b>REGISTER HEALTH CENTER</b></h5>
        </div>
            ...
            <div class="m-3">
              ...
              <div class="m-3">
                <label for="exampleFormControlInput1" class="form-label">Number Of Patients:</label>
              ...
              <div class="m-3 "  style="margin:20px 0;">
                  <button type="submit" class="btn btn-secondary pt-3 m-2 btn-block" style="color:red">Register Health Center</button>
              </div>
