...
<html>
    ...
    <body>
        <h1 style="text-align: center">Please Fill out the form<br/> to schedule a reservation</h1>
...
<!--                    <div style="display: flex;align-items: center; justify-content: center;">
                    ...
                    <div class="m-3">
                        ...
                        <input type="name" class="form-control" name="name" name" required>
                    </div>
...
<!--                    <div class="m-3">
                    ...
                    <div class="m-3 "  style="margin:20px 0;">
                        <a href="./bookreserved.jsp"> <button type="submit" class="btn btn-primary pt-3 m-2 btn-block">Book Now</button></a><!-- comment -->
                    </div>
